...
const SCHEMA_ANALISE = {
  ...
  tipo_credito: 'um de, EXATAMENTE: "Crédito principal — apenas" | "Crédito principal + Honorários" | "Honorários contratuais + sucumbenciais" | "Honorários sucumbenciais — apenas" — são os valores da lista suspensa da célula C3 da aba jurídica, e texto fora dela entra marcado como inválido. ' +
    'COMO CLASSIFICAR: "Honorários", nestas opções, quer dizer verba ACESSÓRIA de uma condenação principal alheia — a contratual, que sai de dentro do crédito do credor, e a sucumbencial, que o vencido paga ao advogado do vencedor. ' +
    'O QUE SE EXECUTA É O PRINCIPAL. Quando a própria pretensão executada é uma verba honorária arbitrada em favor de quem titulariza o crédito — honorários de defensoria dativa ou UHD, de curador especial, de perito, ou verba que o advogado cobra em causa própria —, NÃO existe condenação principal alheia: aquela verba É o crédito principal, e a resposta é "Crédito principal — apenas" (ou "Crédito principal + Honorários", se houver contratuais destacados SOBRE ELA). ' +
  ...
  honorarios_sucumbenciais: 'HONORÁRIOS SUCUMBENCIAIS fixados na sentença ou no acórdão, em reais — o valor que o ENTE DEVEDOR paga ao advogado por ter perdido, separado do que o cliente paga por contrato. Procure na parte dispositiva da sentença/acórdão, na conta da contadoria e no próprio requisitório: costuma vir como verba própria, às vezes em requisitório separado. Se a condenação fixar PERCENTUAL sobre o valor da causa ou da condenação, calcule o valor em reais. ZERO se a sentença não os fixou, se foram compensados, se a Fazenda não foi condenada neles, ou se você não achou — não estime por praxe: um percentual arbitrado por hábito vira dinheiro inventado na precificação. ' +
    'NÃO É SUCUMBENCIAL a verba honorária que é o PRÓPRIO OBJETO da execução — defensoria dativa/UHD, curador especial, perito, advogado em causa própria: ali ela é o crédito principal, vai em "bruto_total", e repeti-la aqui a contaria duas vezes e esvaziaria o bruto',
  ir_origem:
...
'DE QUEM É O RISCO: DE QUEM COMPRA. Este é o ponto em que o raciocínio se inverte, e errar aqui esvazia a auditoria inteira. Quem lê esta análise NÃO é o credor — é o investidor que vai PAGAR pelo crédito hoje e receber do ente depois. Então: ' +
  ...
  'MAS NÃO HÁ ACESSÓRIO SEM PRINCIPAL ALHEIO: numa execução cujo OBJETO é a própria verba honorária — defensoria dativa/UHD, curador especial, perito, advogado em causa própria —, aqueles honorários SÃO a condenação principal e vão em "bruto_total". ' +
  'Tratá-los como sucumbenciais ali esvazia o bruto, joga o crédito para a linha errada da planilha e faz o preço recair sobre uma condenação que não existe. ' +
